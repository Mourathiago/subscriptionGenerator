<?php
	...
	$data .= $_SESSION['adm'] ? '<div class="col-12 text-right"><button class="btn btn-sm btn-success" onclick="i();">Novo modelo</button></div>' : '';
	...
	{
		$data .= '<tr><td>'.$model['nome'].'</td><td><button class="btn btn-sm btn-primary" onclick="j({a:'.$model['id'].'});">Visualizar</button></td></tr>';
	}
